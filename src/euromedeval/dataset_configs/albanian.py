...
ALBANIAN_DATASET_CONFIGS = [
    ...
    DatasetConfig(
        name="entrance-al-systems-sq",
        pretty_name="Albanian Medical Entrance Systems Pool",
        language="sq",
        country="AL",
        task=MEDICAL_ENTRANCE_MCQ.name,
        tier=DatasetTier.SILVER,
        ...
        native=True,
        clinically_reviewed=False,
        creation_script="src/scripts/create_entrance_al_systems_sq.py",
        description="Albanian systems-oriented question pool from the official digital medicine entrance exam.",
        notes="Entrance-track benchmark sourced from QSHA biology systems material.",
    ),
    DatasetConfig(
        name="entrance-al-chemistry-sq",
        pretty_name="Albanian Medical Entrance Chemistry Pool",
        language="sq",
        country="AL",
        task=MEDICAL_ENTRANCE_MCQ.name,
        tier=DatasetTier.SILVER,
        ...
        native=True,
        clinically_reviewed=False,
        creation_script="src/scripts/create_entrance_al_chemistry_sq.py",
        description="Albanian chemistry-oriented question pool from the official digital medicine entrance exam.",
        notes="Entrance-track benchmark sourced from QSHA chemistry profile material.",
    ),
]
