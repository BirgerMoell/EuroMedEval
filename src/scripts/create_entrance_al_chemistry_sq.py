"""Build a normalized JSONL file from the Albanian chemistry entrance exam dataset."""
...
DATASET_ID = "marjpri/albanian-medical-exams-chemistry-mcq-270"
DATASET_NAME = "entrance-al-chemistry-sq"
OUTPUT_PATH = Path("data/processed/entrance_al_chemistry_sq.jsonl")
DEMO_OUTPUT_PATH = Path("data/processed/entrance_al_chemistry_sq_demo.jsonl")
...
def main() -> None:
    ...
    try:
        ...
        records.append(
            DatasetRecord(
                id="entrance-al-chemistry-sq-demo-1",
                language="sq",
                country="AL",
                ...
                split="demo",
                question="Acidi klorhidrik ka formulën:",
                options=("HCl", "H2SO4", "NaCl", "CO2"),
                label="HCl",
                specialty="chemistry",
    ...
    for row in dataset:
        ...
        records.append(
            DatasetRecord(
                id=f"entrance-al-chemistry-sq-{row.get('original_question_num', len(records))}",
                language="sq",
                country="AL",
                dataset_name=DATASET_NAME,
                task=MEDICAL_ENTRANCE_MCQ.name,
